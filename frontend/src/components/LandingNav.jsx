...
const LandingNav = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-[#60A5FA] via-[#3B82F6] to-[#60A5FA]  text-white fixed top-0 left-0 w-full z-20 shadow-lg">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-6 px-2 ">
        <a
        ...
        >
          <Link
            ...
            className="block py-1 px-2  hover:text-[#1B57E9]  text-lg font-medium  hover:border-[#1B57E9]"
          >
